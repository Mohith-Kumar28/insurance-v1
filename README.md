...
| [Member](https://next-shadcn-dashboard-starter.vercel.app/dashboard/member)             | Tanstack tables with server side searching, filter, pagination by Nuqs which is a Type-safe search params state manager in nextjs   |
| [Member/new](https://next-shadcn-dashboard-starter.vercel.app/dashboard/member/new)     | A Member Form with shadcn form (react-hook-form + zod).                                                                             |
